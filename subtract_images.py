...
boosted_sub = cv2.multiply(subtraction, 10)

#różnica jako wartość bezwzględna
diff = cv2.absdiff(img1, img2)
boosted_diff = cv2.multiply(diff, 10)
...
cv2.imwrite('images/subcat15.png', boosted_sub)
cv2.imwrite('images/abscat15.png', boosted_diff)